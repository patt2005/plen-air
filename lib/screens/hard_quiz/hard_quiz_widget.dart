...
import 'hard_quiz_model.dart';
export 'hard_quiz_model.dart';

class HardQuizWidget extends StatefulWidget {
  final String categoryId;
  final int categoryIndex;

  const HardQuizWidget({
    super.key,
  ...
  @override
  State<HardQuizWidget> createState() => _HardQuizWidgetState();
}

class _HardQuizWidgetState extends State<HardQuizWidget> {
  late HardQuizModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HardQuizModel());
              ...
              child: Stack(
                children: [
                  ...
                  Align(
                    ...
                    child: Padding(
                      padding:
                          const EdgeInsetsDirectional.fromSTEB(220, 50, 0, 50),
                      child: Container(
                        width: 139,
                        height: 73,
                  ...
                  Align(
                    ...
                    child: Padding(
                      padding:
                          const EdgeInsetsDirectional.fromSTEB(0, 50, 220, 50),
                      child: Container(
                        width: 139,
                        height: 73,
                        decoration: BoxDecoration(
                  ...
                  Align(
                    ...
                    child: Padding(
                      padding:
                          const EdgeInsetsDirectional.fromSTEB(100, 30, 0, 65),
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(8),
                        child: Image.asset(
                  ...
                  Align(
                    ...
                    child: Padding(
                      padding:
                          const EdgeInsetsDirectional.fromSTEB(280, 50, 10, 55),
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(8),
                        child: Image.asset(
                          'assets/images/Umbrella.png',
